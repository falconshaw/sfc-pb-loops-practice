...
#           * Inside the loop, ask the user to input a character for the
#           current row.
#           * Inside the loop, ask the user to input a number of characters for
#           the current row.
#           * Add each to the appropriate empty list.
#       * In a separate loop, iterate over the number of columns.
#           * Inside the loop, iterate over the number of characters for the
#           current row.
